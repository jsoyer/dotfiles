> **Note**: This command references the ECC framework. Install via `/plugin install everything-claude-code` for full functionality. Without it, use the instructions below as guidance.
