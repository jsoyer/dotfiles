    ...
    with sync_playwright() as p:
        try:
            ...
            try:
                ...
                print(
                    "Warning: Page Load Timeout. Attempting to extract partial content.",
                    file=sys.stderr,
                )
            ...
            for art in articles:
                ...
                try:
                    ...
                    candidates.append(
                        {"title": title, "url": href, "heat": "Trending", "summary": ""}
                    )
                except:
                    continue
            ...
            for item in candidates:
                try:
                    ...
                    try:
                        page.goto(
                            item["url"], timeout=60000, wait_until="domcontentloaded"
                        )
                    except:
                        sys.stderr.write(
                            "   -> Detail Page Timeout (Partial/Continue)\n"
                        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--limit", type=int, default=10, help="Number of papers to fetch"
    )
